...
public class AccountServiceTest {
	...
	@Test
	public void allAccountbyAFirstName() {
		Account acc1 = new Account(1, "D0001", "Matt", "Hunt");
		Account acc2 = new Account(2, "D0002", "Bert", "Smith");
		Account acc3 = new Account(3, "D0003", "Matt", "Wills");

		amr.getAccountMap().put(1, acc1);
		amr.getAccountMap().put(2, acc2);
		amr.getAccountMap().put(3, acc3);

		int count = amr.findNames("Matt");
